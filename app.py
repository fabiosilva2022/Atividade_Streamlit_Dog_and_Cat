...
colab_link = "[Clique aqui para acessar o notebook de treinamento no Google Colab](https://colab.research.google.com/drive/1sTRYiSgJsqAh0FZdq6BUOkidos1vV0W7#scrollTo=PLFqnHvIJSaW)"
...
if uploaded_file is not None:
    ...
    MODEL_PATH = 'modelo_cachorro_gato.h5'  # Certifique-se de que o arquivo está na mesma pasta
